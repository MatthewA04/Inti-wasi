...
export default function Footer() {
  return (
    <footer>    <div className="footer">
      <a href='#' ><img src={footerImg} className="footer-logo" alt="Logo Inti Wasi" /></a>
  <div className="footer-container">


    <div className="footer-left">
      <a href='#'><p>Política de Privacidad</p></a>
      <a href='#'><p>Términos & Condiciones</p></a>
      <a href='#'><p>Libro de Reclamaciones</p></a>
    </div>
    ...
    <div className="footer-center">
      ...
      <div className="footer-social">
        <a href="https://instagram.com/"><img src={facebookImg} alt="Facebook" /></a>
        <a href="https://facebook.com/"><img src={instagramImg} alt="Instagram" /></a>
      </div>
    </div>
